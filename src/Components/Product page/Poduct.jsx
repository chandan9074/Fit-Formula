    ...
    return ( 
        ...
        <div  className="container mb-5">
            <div className="flex justify-between items-center my-3">
                <h1 className="text-4xl text-gray-200 font-bold">Equipment</h1>
            ...
            <div className="grid md:grid-cols-3 gap-4">
            {
                instrument.map(instru =>(
                    <div className="bg-gray-600 product-card p-5 rounded-lg">
                        ...
                        <h1 className="text-gray-300 product-title" title={instru.name}>{instru.name}</h1>
                        <div className="text-yellow-500 flex justify-between items-center" >
                            <h1 className="text-3xl"><i class="fas fa-money-bill-wave"></i> {instru.price}</h1>
            ...
            <div className="flex justify-between items-center my-3">
                <h1 className="text-4xl text-gray-200 font-bold">Shoes</h1>
                <Link to="" className="visit-btn rounded-full font-semibold">See more</Link>
            </div>
            ...
            <div className="flex justify-between items-center my-3">
                <h1 className="text-4xl text-gray-200 font-bold">Gym Suit</h1>
                <Link to="" className="visit-btn rounded-full font-semibold">See more</Link>
            </div>
            <div className="grid md:grid-cols-3 gap-4">
            {
